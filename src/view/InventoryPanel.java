...
public class InventoryPanel extends JPanel {
    ...
    public InventoryPanel(MainApp mainApp, InventoryController controller) {
        ...
        this.tableModel = new ComputerTableModel(controller.getComputerList() != null ? controller.getComputerList() : new ArrayList<>());
        initComponents();
    ...
    private void initComponents() {
        ...
        gbcTop.gridx = 0; gbcTop.gridy = 1; // Segunda linha
        ...
        backButton.addActionListener(e -> {
            if(searchField != null) searchField.setText(""); // Limpa busca ao voltar
        ...
        editButton.addActionListener(e -> {
            ...
            if (selectedRowView >= 0) {
                ...
                if (selectedComputer != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "Não foi possível obter os dados do computador selecionado.", "Erro", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Selecione um computador para editar.", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        });
        ...
        deleteButton.addActionListener(e -> {
            ...
            if (selectedRowView >= 0) {
                ...
                JOptionPane.showMessageDialog(this, "Selecione um computador para excluir.", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        });
    ...
    private void filterTable() {
        ...
        if (!query.isEmpty()) {
            ...
            listToFilter = listToFilter.stream().filter(computer ->
                    (computer.getTag() != null && computer.getTag().toLowerCase().contains(finalQuery)) ||
                            ...
                            (computer.getUserName() != null && computer.getUserName().toLowerCase().contains(finalQuery))
            ).collect(Collectors.toList());
        }
    ...
    public void setLocationFilter(String location) {
        ...
        if (searchField != null) { searchField.setText(""); } // Limpa busca
    ...
    private void handleExportAction(Component parent) {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                // Chama a assinatura original do controller (exporta tudo da lista interna do controller)
                ...
                JOptionPane.showMessageDialog(parent, "Não foi possível exportar os dados: "+ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace(); // Log no console
            } catch (Exception ex) { // Captura outras exceções
                JOptionPane.showMessageDialog(parent, "Ocorreu um erro inesperado ao exportar: "+ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                ex.printStackTrace();
            }
        }
    }
    ...
    private void openUserManagementWindow() {
        ...
        editPasswordButton.addActionListener(e -> {
            ...
            if (selectedUser != null) {
                ...
                JOptionPane.showMessageDialog(userManagementFrame, "Selecione um usuário.", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        });
        ...
        deleteUserButton.addActionListener(e -> {
            ...
            if (selectedUser != null) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(userManagementFrame, "Erro ao excluir usuário: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(userManagementFrame, "Selecione um usuário.", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        ...
        saveButton.addActionListener(e -> {
            ...
            if (newPassword.isEmpty()) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(editPasswordFrame, "Erro ao atualizar senha: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    }
